...
const CustomInput = ({ label, icon, value, onChangeText, isPassword, showPassword, setShowPassword, placeholder }) => {
                        ...
                        <BlurView intensity={20} tint="light" style={styles.blurContainer}>
                            <View style={styles.formContent}>
                                ...
                                <TouchableOpacity
                                    ...
                                    <Ionicons name="arrow-forward-outline" size={14} color="#6366f1" />
                                </TouchableOpacity>
